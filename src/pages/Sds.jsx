    ...
    return (
      ...
      <section className={styles.intro}>
        <p>
          ...
          A study permit grants you the authorization to stay in Canada for educational purposes. It contains essential information about you, including:
        </p>
        <ul>
          ...
          <li>Whether you can work on- or off-campus during your studies, along with any associated restrictions.</li>
        </ul>
      ...
      <section className={styles.fasterProcessing} id="faster-processing">
        ...
        <ul>
          <li>Provide Biometrics: If required, submit your biometrics promptly.</li>
          <li>Meet Eligibility Requirements: Ensure you meet all eligibility criteria.</li>
        </ul>
      ...
      <section className={styles.eligibility} id="eligibility">
        ...
        <ul>
          ...
          <li>Possess an acceptance letter from a post-secondary designated learning institution (DLI).</li>
          ...
          <li>Submit your most recent secondary or post-secondary transcripts.</li>
          <li>Demonstrate sufficient language proficiency through a recognized language test result (see Language Test Results below).</li>
        </ul>
        <p>Depending on your study location and personal circumstances, you may need to:</p>
        <ul>
          <li>Obtain a Certificat d’acceptation du Québec (CAQ) if planning to study in Quebec.</li>
      ...
      <section className={styles.applicationProcess}>
        ...
        <ol>
          <li>
            ...
            <p>As of January 22, 2024, most students planning to study in Canada must provide a Provincial Attestation Letter (PAL) specific to their chosen study location. A PAL serves as an electronic certification, confirming a student’s eligibility to apply for a study permit within a province’s quota. Note: Master’s degree, doctoral degree, and K-12 students are exempt from the PAL requirement.</p>
          </li>
          <li>
            <h3>Proof of First-Year Tuition Payment</h3>
            <p>Students can demonstrate full payment of their first year’s tuition by including one of the following documents with their application:</p>
            <ul>
              <li>A receipt from the Designated Learning Institution (DLI)</li>
              <li>An official letter from the DLI confirming payment</li>
              <li>A bank receipt indicating funds transferred to the DLI</li>
              <li>Proof of funds in a repository account at the DLI for future tuition payments</li>
            </ul>
          </li>
          <li>
            ...
            <table className={styles.fundsTable}>
              ...
              <tbody>
                <tr><td>Tuition Fees</td><td>$20,000.00</td></tr>
                <tr><td>Living Expense</td><td>$20,636.00</td></tr>
                <tr><td>Transportation</td><td>$2,000.00</td></tr>
                <tr><td>Minimum Funds Required</td><td>$42,636.00</td></tr>
              </tbody>
            </table>
            <table className={styles.fundsTable}>
              <thead>
              ...
              <tbody>
                <tr><td>Tuition Fees</td><td>$20,000.00</td></tr>
                <tr><td>Living Expense</td><td>$25,691.00</td></tr>
                <tr><td>Transportation</td><td>$4,000.00</td></tr>
                <tr><td>Minimum Funds Required</td><td>$49,691.00</td></tr>
              </tbody>
            </table>
            <table className={styles.fundsTable}>
              <thead>
              ...
              <tbody>
                <tr><td>Tuition Fees</td><td>$20,000.00</td></tr>
                <tr><td>Living Expense</td><td>$38,346.00</td></tr>
                <tr><td>Transportation</td><td>$8,000.00</td></tr>
                <tr><td>Minimum Funds Required</td><td>$66,346.00</td></tr>
              </tbody>
            </table>
          </li>
          <li>
            <h3>Medical Exam</h3>
            <p>You may need to undergo a medical exam conducted by an Immigration, Refugees and Citizenship Canada (IRCC)-approved doctor if:</p>
            <ul>
              <li>You have lived or traveled in certain countries or territories for six months or longer in the year before coming to Canada.</li>
              <li>You plan to study or work in fields related to health, primary or secondary education, child care, or elder care.</li>
            </ul>
          </li>
          <li>
            <h3>Police Certificate</h3>
            <p>To determine whether you need to submit a police certificate, select your country of residence from the menu and refer to the specific visa office instructions.</p>
          </li>
          <li>
            <h3>Language Test Results</h3>
            <p>Include your language test results demonstrating proficiency in English or French. As of August 10, 2023, SDS applicants can submit English proficiency test results from four new providers:</p>
            <ul>
              <li>Canadian Academic English Language (CAEL)</li>
              <li>Canadian English Language Proficiency Index Program (CELPIP General)</li>
            ...
            <table className={styles.languageTable}>
              ...
              <tbody>
                <tr><td>IELTS Academic (Grade 12)</td><td>Overall 6.0 - 5.5 acceptable in one of the modules</td></tr>
                <tr><td>IELTS Academic (Graduation)</td><td>Overall 6.5 - no less than 6 in any of the modules</td></tr>
                <tr><td>CELPIP General</td><td>7 in each module</td></tr>
                <tr><td>PTE Academic</td><td>60</td></tr>
                <tr><td>TOEFL iBT</td><td>83</td></tr>
                <tr><td>CAEL</td><td>60</td></tr>
                <tr><td>NIVEAUX DE compétence linguistique canadiens</td><td>score of at least 7 for French*</td></tr>
              </tbody>
            </table>
          </li>
        </ol>
      ...
      <section className={styles.family} id="family">
        ...
        <p>To benefit from expedited processing, their completed applications must be submitted alongside yours. When applying, select the option indicating that you have family members accompanying you to Canada.</p>
        <p><strong>Is my spouse or common law partner eligible for an Open Work Permit?</strong> As of March 19, 2024, to be eligible to apply for a Spousal Open Work Permit as an international student, you must be enrolled in one of the following programs:</p>
        <ul>
          <li><strong>Graduate Programs:</strong> Master’s and doctorate degrees granted by universities or polytechnic institutions.</li>
      ...
      <section className={styles.exclusions} id="exclusion">
        ...
        <ul>
          ...
          <li>If you live in a different country (even if you’re a citizen of the 14 eligible countries) or don’t meet the eligibility criteria for faster processing, you may still be eligible for a study permit through the standard application process.</li>
        </ul>
      </section>
      ...
      <section className={styles.applicationSubmission} id="application-submission">
        ...
        <p>Most students need to provide biometrics and should pay the fee along with their online application. If you require assistance with biometrics or passport submission, visit a visa application centre (VAC).</p>
        <h3>After You Apply</h3>
        <p>Book an appointment to provide your biometrics after submitting your study permit application through the Student Direct Stream. You’ll receive an instruction letter detailing where and how to provide your biometrics within 30 days. Bring this letter and your valid passport to your appointment. If you didn’t pay the biometrics fee during application, you’ll receive a reminder letter. The visa office won’t process your application until you’ve provided biometrics.</p>
        <h3>Processing Time</h3>
        <p>The visa office typically processes most applications within 20 calendar days after receiving biometrics from eligible applicants. If your application doesn’t meet the eligibility criteria for the Student Direct Stream, it will be reviewed as a regular study permit application, without faster processing.</p>
