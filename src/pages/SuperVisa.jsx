    ...
    <>
      ...
      <section className={styles.benefits}>
        ...
        <ul>
          ...
          <li>This is a multiple-entry visa option, granting multiple entries over up to 10 years or until the passport expires.</li>
        </ul>
      </section>
      ...
      <section className={styles.eligibility}>
        ...
        <ul>
          ...
          <li>Provide proof of your relationship with your parents or grandparents.</li>
          <li>Meet the income requirements set by the Government of Canada. Check the income requirement in the chart below:</li>
          <li>Provide proof that you have medical insurance for your parents/grandparents from a Canadian insurance company. The insurance must meet the following criteria:
            <ul>
              <li>Valid for at least one year from the date of entry.</li>
              <li>Coverage of at least $100,000.</li>
              <li>Proof that the medical insurance has been paid in full or that monthly payments have been set up.</li>
            </ul>
          </li>
        </ul>
        ...
        <ul>
          <li>Their Super Visa application must be submitted from outside Canada.</li>
          <li>They must pass the immigration medical exam to qualify.</li>
          <li>They must meet the requirement to pass a security and health eligibility check.</li>
          <li>If they are inadmissible to Canada, they do not qualify for this program.</li>
        </ul>
      </section>
      ...
      <section className={styles.applicationProcess}>
        ...
        <ol>
          <li>Check your income requirements to ensure you meet the latest standards.</li>
          <li>Obtain upfront medical clearance from a doctor authorized by IRCC.</li>
          <li>Secure medical insurance that complies with IRCC guidelines.</li>
          <li>Complete all required documents for the Super Visa application.</li>
      ...
      <section className={styles.refusalReasons}>
        ...
        <ul>
          ...
          <li>Immigration officer feels that your ties to your home country are not strong. This means you have not demonstrated strong connections to your home country, such as a job, family, and property.</li>
          <li>Immigration officer feels that you will not leave Canada at the end of your stay. This means the officer believes you have intentions to immigrate to Canada permanently.</li>
          <li>You have previous refusals from IRCC that have not been explained in the current application submission. This means you have prior applications that were denied and you have not provided a satisfactory explanation for those refusals.</li>
          <li>Your medical insurance coverage was inadequate according to the set requirements. This means the insurance policy you provided does not meet the minimum coverage standards required for Super Visa holders.</li>
          <li>Documents you provided were either incomplete or inaccurate. This means the documents you submitted were not complete or contained errors, which may lead to refusal and even misrepresentation charges.</li>
        </ul>
