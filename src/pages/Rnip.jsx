        ...
        <section >
          ...
          <ol >
            <li>
              ...
              (IRCC). This could include things like having the right education,
              work experience, language skills, and more.
            </li>
            <li>
              Community-specific requirements: On top of the IRCC rules, each
              participating community may have its own unique eligibility
              criteria. You'll need to research the specific community you're
          ...
          <ol>
            ...
            <li>
              ...
              recommendation to the community you want to live in.
            </li>
            <li>
              Apply for permanent residence: If the community recommends you,
              you can then move on to the final step of applying for permanent
              residence through the federal government.
            </li>
          </ol>
          ...
          <ul>
            <li>
              ...
              <ul>
                <li>
                  Were studying as a full-time student for the full duration of
                  the 2+ years
                </li>
                <li>
                ...
                <li>
                  Were in the community for at least 16 of the last 24 months
                  spent studying to get your credential
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                <li>
                  Were studying as a full-time student for the duration of your
                  degree
                </li>
                <li>
                  Got your degree no more than 18 months before your application
