  ...
  return (
    <>
      ...
      <section className={styles.introduction}>
        <p>
          The Temporary Resident Permit (TRP) is a legal document issued by Citizenship and Immigration Canada (CIC) that allows individuals who are inadmissible to Canada to temporarily visit and stay in the country under very specific circumstances.
        </p>
      </section>
      ...
      <section className={styles.refusalReasons} id="refusal-reasons">
        ...
        <ul>
          ...
          <li>Individuals linked to terrorism, espionage, or other threats to national security may be considered inadmissible.</li>
          <li>Convictions for serious crimes, including murder, manslaughter, drug trafficking, and organized crime offenses, can lead to a refusal.</li>
          <li>Involvement in criminal organizations or gangs can render an individual refusal.</li>
          <li>Providing false or misleading information during the application process or any previous immigration interactions can result in a refusal.</li>
          <li>Failure to comply with Canadian immigration laws, such as overstaying a visa, can make an individual inadmissible.</li>
        </ul>
      </section>
