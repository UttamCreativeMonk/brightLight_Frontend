  ...
  return (
    <>
      ...
      <section className={styles.eligibility} id="eligibility">
        ...
        <ol>
          <li>Be married or in a common-law partnership with a Canadian citizen, permanent resident, or a person with a valid Canadian work permit or study permit.</li>
          <li>Provide genuine evidence of your relationship with your partner.</li>
          <li>Be admissible to Canada, including being free from any criminal or medical grounds of inadmissibility.</li>
          <li>In some cases, prove that you have sufficient funds to support yourself during your stay in Canada.</li>
        </ol>
      ...
      <section className={styles.applicationProcess} id="how-to-apply">
        ...
        <ol>
          ...
          <li>Proof of your relationship (a marriage certificate or proof of common-law relationship, etc).</li>
          <li>Documentation highlighting the authenticity of your relationship bond.</li>
      ...
      <section className={styles.refusalReasons} id="refusal-reasons">
        ...
        <ul>
          <li><strong>Genuineness of Relationship:</strong> The strength of your relationship with your spouse or common-law partner is a cornerstone of the SOWP application. To convince the officer of the authenticity of your bond, provide ample evidence of your shared history, such as joint bank statements, shared property ownership, joint travel documents, etc.</li>
          <li><strong>Insufficient Proof of Funds:</strong> Showing financial stability is essential for securing a SOWP. Gather all supporting documents that showcase your and your spouse's ability to support yourselves in Canada, such as bank statements, employment letters, tax returns, etc.</li>
          <li><strong>Lack of Ties to Home Country:</strong> The officer needs assurance that you intend to return to your home country once your stay in Canada concludes. Provide evidence of your strong ties to your native land, including property ownership, employment opportunities, etc.</li>
          <li><strong>School Enrollment Proof (if applicable):</strong> To make your application stronger, provide solid evidence that your sponsor is currently enrolled in and actively attending classes at a designated learning institution (DLI) in Canada. Failure to do so could significantly hinder your application's chances of approval.</li>
        </ul>
      </section>
