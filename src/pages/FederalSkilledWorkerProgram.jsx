    ...
    <>
      ...
      <section className={styles.eligibility}>
        ...
        <ul>
          ...
          <li>You must have at least one year of full-time post-secondary education or an equivalent qualification, assessed through an Educational Credential Assessment (ECA) for immigration purposes.</li>
          <li>A minimum level of approved language tests in English or French for writing, reading, listening, and speaking is essential.</li>
        ...
        <table className={styles.table}>
          ...
          <tbody>
            <tr>
              ...
              <td>Advertising, marketing and public relations managers, Financial managers</td>
            </tr>
            <tr>
              <td>TEER 1</td>
            ...
            <tr>
              <td>TEER 2</td>
              <td>Occupations that usually require:
                <ul>
              ...
              <td>Computer network and web technicians, Medical laboratory technologists</td>
            </tr>
            <tr>
              <td>TEER 3</td>
              <td>Occupations that usually require:
              ...
              <td>Bakers, Dental assistants and dental laboratory assistants</td>
            </tr>
            <tr>
              <td>TEER 4</td>
              <td>Occupations that usually require:
              ...
              <td>Home child care providers, Retail salespersons and visual merchandisers</td>
            </tr>
            <tr>
              <td>TEER 5</td>
              <td>Occupations that usually need short-term work demonstration and no formal education</td>
              <td>Landscaping and grounds maintenance labourers, Delivery service drivers and door-to-door distributors</td>
            </tr>
          </tbody>
        </table>
      ...
      <section className={styles.applicationProcess}>
        ...
        <ol>
          ...
          <li>Collect all required documentation to support your application, such as education certificates, language test results, work experience letters, and any other relevant documents.</li>
          <li>Place your profile in the Express Entry pool. Your CRS score will determine your position in the pool.</li>
          <li>You will receive an ITA if your CRS score is high enough and meets the requirements.</li>
          <li>Submit a complete application for permanent residency within 60 days of receiving the ITA.</li>
          <li>Provide additional documentation and undergo medical examinations as required. Your application will be processed, and a decision will be made.</li>
        </ol>
      </section>
      ...
      <section className={styles.refusalReasons}>
        ...
        <ul>
          ...
          <li>Your Comprehensive Ranking System (CRS) score isn’t high enough.</li>
          <li>Criminal convictions, health issues, or security concerns may make you inadmissible. Exceptions and waivers may apply.</li>
          <li>You did not submit all the required documents and provided inaccurate information.</li>
          <li>You failed to provide sufficient proof of funds to support yourself or your family in Canada.</li>
        </ul>
      </section>
