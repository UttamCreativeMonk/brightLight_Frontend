    ...
    return (
      ...
      <section className={styles.benefits}>
        ...
        <ul>
          ...
          <li>By not needing to travel outside of Canada, you save money on travel expenses such as flights, accommodation, and other associated costs.</li>
          <li>Applying for an extension ensures that you adhere to Canadian immigration laws and regulations, avoiding any potential penalties or issues with future visa applications.</li>
        </ul>
      </section>

      <section className={styles.applicationProcess}>
        <h2 className={styles.subheading}>How to Apply for an Extension of Temporary Status?</h2>
        <p>To extend your visitor status in Canada, you'll need to gather the following documents. Please note that this is a general list, and you may be required to provide additional documents depending on your specific circumstances.</p>
        <ul>
          <li>Complete the appropriate visitor record extension application forms.</li>
          <li>Pay the applicable application fee.</li>
          <li>Submit a copy of your valid passport.</li>
          <li>Provide evidence of sufficient financial funds to support yourself.</li>
          <li>Provide a strong reason why you want to continue to live in Canada.</li>
          <li>Provide compelling reasons about why you will leave Canada after the end of the proposed stay.</li>
        </ul>
      </section>

      <section className={styles.assistance}>
        <h2 className={styles.subheading}>Still Not Sure?</h2>
        <p>If you have received a refusal for any reason, do not worry. With over a decade of experience, we specialize in previously refused cases. We have secured approvals for clients who had multiple previous refusals. We achieve this with a tailored approach to your specific case, addressing each concern that the officer has listed in previous refusals. We use case law and find similar cases to your circumstances that had positive results, and we use them as precedents in cases we work on. This is why we have a high success rate.</p>
