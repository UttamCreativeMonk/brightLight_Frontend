    ...
    <>
      ...
      <section className={styles.benefits} id="benifits">
        ...
        <ul>
          ...
          <li>It permits your spouse or common-law partner to work, alleviating financial strain on you while you are in school full-time.</li>
          <li>It provides your spouse or common-law partner with the opportunity to gain Canadian work experience and enhance their skills.</li>
          ...
          <li>It also offers a chance to immerse oneself in Canadian society.</li>
        </ul>
      </section>
      ...
      <section className={styles.eligibility} id="eligibility">
        ...
        <table className={styles.table}>
          ...
          <tbody>
            <tr>
              ...
              <td>Must be attending a designated learning institution (DLI).</td>
            </tr>
            <tr>
              <td>Full-Time Study</td>
              <td>Must be actively studying full-time in a post-graduation work permit-eligible program at:
                <ul>
        ...
        <table className={styles.table}>
          ...
          <tbody>
            <tr>
              ...
              <td>Must hold a valid study permit AND be physically residing in Canada while studying or be approved for a study permit if applying as a family group outside of Canada AND provide proof that they plan to physically reside in Canada while studying.</td>
            </tr>
            <tr>
              <td>Full-Time Study</td>
              <td>Must be studying on a full-time basis in a graduate program (master’s and doctorate) in a university or polytechnic institution, or a professional degree-granting program in a university (e.g., medicine, dentistry, law, etc.).</td>
            </tr>
            <tr>
              <td>Graduate and Professional Programs</td>
              <td>Graduate programs include master’s and doctorate degrees. Professional degree programs include:
                <ul>
        ...
        <h3>Eligibility Requirements for Accompanying Spouse or Common-law Partner</h3>
        <ul>
          <li>General Eligibility: The applicant must meet general work permit criteria, including police and medical clearances, and not be inadmissible to Canada.</li>
          <li>Relationship: A genuine relationship between the applicant and the study permit holder is required.</li>
          <li>Proof of Spousal Relationship: Evidence must demonstrate the applicant's genuine status as the spouse or common-law partner of a valid study permit holder.</li>
          <li>Additional Documentation: Supplementary proof is necessary to satisfy IRCC that the relationship was not primarily for status acquisition or is not genuine.</li>
          <li>Applicants in Canada: They must possess valid temporary resident status, have applied for an extension before its expiry (maintained status), or be eligible for restoration of status as a visitor, worker, or student. They must also be eligible to apply for a work permit from within Canada.</li>
        </ul>
      </section>
      ...
      <section className={styles.refusalReasons} id="refusal-reasons">
        ...
        <ul>
          ...
          <li>Inadequate evidence demonstrating the genuineness of the marriage.</li>
          <li>The principal applicant's study permit is nearing expiration, and there has been no application filed to extend their stay.</li>
        </ul>
      </section>

      <section className={styles.assistance} >
        <h2 className={styles.subheading}>Need Assistance?</h2>
        <p>If you need help with your application or have questions, feel free to <Link to="/contact-us">contact us</Link>. Our team at Brightlight Immigration is here to assist you every step of the way.</p>
      </section>
