  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        <h2  className={`${styles.subtitle} ${styles.section}`} id="key-points" ref={(el) => sectionsRef.current[3] = el}>
        ...
        <div className={`${styles.criteria} ${styles.section}`} id="testing4" ref={(el) => sectionsRef.current[6] = el}>
          ...
          <h3 className={`${styles.subheading} ${styles.section}`} id="testing6" ref={(el) => sectionsRef.current[8] = el}>Work Experience</h3>
          <ul className={`${styles.list} ${styles.section}`} id="testing7" ref={(el) => sectionsRef.current[9] = el}>
          ...
          <h3 className={`${styles.subheading} ${styles.section}`} id="testing8" ref={(el) => sectionsRef.current[10] = el} >Education</h3>
          ...
          <h3 className={`${styles.subheading} ${styles.section}`} id="testing10" ref={(el) => sectionsRef.current[12] = el}>Language Proficiency</h3>
          <ul className={`${styles.list} ${styles.section}`} id="testing11" ref={(el) => sectionsRef.current[13] = el}>
            <li className={styles.listItem}>Attain a Canadian Language Benchmark (CLB) score of at least 4 in English or French.</li>
          </ul>

          <h3 className={`${styles.subheading} ${styles.section}`} id="testing12" ref={(el) => sectionsRef.current[14] = el}>Eligible ELSS Occupations</h3>
          <div className={`${styles.occupations} ${styles.section}`} id="testing13" ref={(el) => sectionsRef.current[15] = el}>
            <h4  className={`${styles.occupationTitle} ${styles.section}`} id="testing14" ref={(el) => sectionsRef.current[16] = el}>Occupations in Travel and Accommodation</h4>
            <ul className={`${styles.list} ${styles.section}`} id="testing5" ref={(el) => sectionsRef.current[17] = el}>
              <li className={styles.listItem}>64314 Hotel front desk clerks</li>
            </ul>

            <h4 className={`${styles.occupationTitle} ${styles.section}`} id="testing15" ref={(el) => sectionsRef.current[8] = el}>Tour and Recreational Guides and Casino Occupations</h4>
            <ul className={`${styles.list} ${styles.section}`} id="testing16" ref={(el) => sectionsRef.current[18] = el}  >
            ...
            <h4  className={`${styles.occupationTitle} ${styles.section}`} id="testing17" ref={(el) => sectionsRef.current[19] = el}>Occupations in Food and Beverage Service</h4>
            <ul className={`${styles.list} ${styles.section}`} id="testing18" ref={(el) => sectionsRef.current[20] = el}>
            ...
            <h4  className={`${styles.occupationTitle} ${styles.section}`} id="testing19" ref={(el) => sectionsRef.current[21] = el}>Cleaners (Employed Directly by Hotels/Resorts)</h4>
            <ul className={`${styles.list} ${styles.section}`} id="testing20" ref={(el) => sectionsRef.current[22] = el}>
            ...
            <h4  className={`${styles.occupationTitle} ${styles.section}`} id="testing21" ref={(el) => sectionsRef.current[23] = el}>Other Service Occupations (Employed Directly by Hotels/Resorts)</h4>
            <ul className={`${styles.list} ${styles.section}`} id="testing22" ref={(el) => sectionsRef.current[24] = el}>
            ...
            <h4  className={`${styles.occupationTitle} ${styles.section}`} id="testing23" ref={(el) => sectionsRef.current[25] = el}>Food Processing</h4>
            <ul className={`${styles.list} ${styles.section}`} id="testing24" ref={(el) => sectionsRef.current[26] = el}>
        ...
        <h2 className={`${styles.subtitle} ${styles.section}`} id="how-to-apply" ref={(el) => sectionsRef.current[27] = el}>
          Application Process for British Columbia Entry Level and Semi-Skilled Worker Stream
        </h2>
        <ul className={`${styles.list} ${styles.section}`} id="testing25" ref={(el) => sectionsRef.current[28] = el}>
        ...
        <h2  className={`${styles.subtitle} ${styles.section}`} id="testing26" ref={(el) => sectionsRef.current[29] = el}>
          Still Not Sure?
        </h2>
        <p className={`${styles.description} ${styles.section}`} id="testing27" ref={(el) => sectionsRef.current[30] = el}>
        ...
        <p className={`${styles.description} ${styles.section}`} id="testing28" ref={(el) => sectionsRef.current[31] = el}>
        ...
        <h2 className={`${styles.subtitle} ${styles.section}`} id="why-choose-us" ref={(el) => sectionsRef.current[32] = el}>
          Why Choose Us?
        </h2>
        <p className={`${styles.description} ${styles.section}`} id="testing29" ref={(el) => sectionsRef.current[33] = el}>
          At Brightlight Immigration, we offer:
        </p>
        <ul className={`${styles.list} ${styles.section}`} id="testing30" ref={(el) => sectionsRef.current[34] = el}>
