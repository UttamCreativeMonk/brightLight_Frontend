  ...
  return (
    <div className={styles.privacyContainer}>
      ...
      <p>
        ...
        and may operate other websites. It is our policy to respect your privacy
        regarding information we may collect while operating our websites. We
        created this Privacy Policy in order to demonstrate our commitment to
      ...
      <p>
        ...
        license your personal information including your name, phone number, or
        email address to third parties without your consent. All information
        provided is kept in the strictest confidence. Brightlight Immigration
        discloses potentially-identifying and personally-identifying information
        only to its employees, contractors, or affiliated organizations where
        necessary to process it on Brightlight Immigration's behalf or to
        provide services available at Brightlight Immigration’s websites.
      </p>

      <h2 className={styles.subheading}>Website Visitors</h2>
      <p>
        We use your IP address to help us identify problems with our server and
        to administer our website. We also use your IP address to gather broad
        demographic information for our internal use. Brightlight Immigration
        collects non-personally-identifying information to better understand how
        our visitors use our website.
      </p>
      ...
      <p>
        ...
        acquired or in the unlikely event that Brightlight Immigration goes out
        of business, user information would be one of the assets that is
      ...
      <p>
        ...
        parties who are not affiliated with Brightlight Immigration. We are not
      ...
      <p>
        ...
        Please note that any information disclosed in this forum becomes public
        information.
      </p>
