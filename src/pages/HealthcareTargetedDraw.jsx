  ...
  return (
    <>
      ...
      <section className={styles.eligibleOccupations}>
        ...
        <ul>
          <li>Within the last 3 years, you have at least 6 months of full-time, continuous work experience (or an equivalent amount of part-time work experience) in a single eligible National Occupational Classification (NOC) in the healthcare sector.</li>
          <li>A valid Express Entry profile.</li>
        </ul>
        <p><a href="https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/submit-profile/rounds-invitations/category-based-selection.html" target="_blank" rel="noopener noreferrer" className={styles.link}>Healthcare Jobs targeted By Express Entry</a></p>
        ...
        <table className={styles.table}>
          ...
          <tbody>
            ...
            <tr>
              <td>Kinesiologists and other professional occupations in therapy and assessment</td>
              <td>31204</td>
              <td>1</td>
            </tr>
            <tr>
      ...
      <section className={styles.applicationProcess}>
        ...
        <ol>
          ...
          <li>Prove that you have at least six months of eligible work experience in healthcare (within the three years preceding the issuance of an ITA and receipt of your application by IRCC)</li>
          <li>Await an ITA (or take steps to improve your CRS score to increase your chances of receiving an ITA)</li>
          <li>Respond to the ITA by submitting your application for permanent residency</li>
          <li>Wait for a decision from an IRCC officer. If approved, you can become a permanent resident of Canada.</li>
        </ol>
        <p>Remember, the key to success in the Express Entry system is to ensure you meet all the eligibility requirements and continuously work on improving your CRS score.</p>
      </section>
