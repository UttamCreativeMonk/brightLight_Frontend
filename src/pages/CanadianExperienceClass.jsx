    ...
    <>
      ...
      <section className={styles.eligibility} id="eligibility">
        ...
        <ul>
          ...
          <li>Work experience must have been gained while authorized to work in Canada. Work experience gained while you were a visitor or student does not count.</li>
          <li>You must have performed the main duties of your job and been able to perform most of the duties listed in the lead statement of the occupational description for your job.</li>
          <li>A valid language test score for English or French is required, depending on the occupation.</li>
          <li>You should meet the minimum Canadian Experience Class Comprehensive Ranking System (CRS) score in the Express Entry system.</li>
        </ul>
      </section>
      ...
      <section className={styles.applicationProcess} id="how-to-apply">
        ...
        <ol>
          ...
          <li>Receive an invitation to apply (ITA) from IRCC. Note that only the highest-ranked candidates receive an ITA for permanent residence.</li>
          <li>Once you receive the ITA, submit your complete application, including supporting documents and fees, within 60 days.</li>
          <li>Wait for processing. IRCC will assess your application and decide whether to grant you permanent residence.</li>
        </ol>
      </section>
      ...
      <section className={styles.refusalReasons} id="refusal-reasons">
        ...
        <ul>
          ...
          <li>Failure to include essential paperwork, such as work experience letters, language test results, and your passport.</li>
          <li>Profile does not meet the minimum requirements for age, education, work experience, language skills, or job offer.</li>
          <li>Criminal convictions or health conditions that could make you inadmissible to Canada. Check your admissibility status with the Canadian government or let us handle it for you. <Link to="/book-appointment" className={styles.link}>Click here</Link>.</li>
          <li>Working in Canada without authorization or gaining work experience in Canada without temporary resident status.</li>
        </ul>
      </section>
